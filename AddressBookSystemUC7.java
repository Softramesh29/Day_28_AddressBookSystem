...
public class AddressBookSystemUC7 {
		...
		AddressBookSystemUC7(String firstName, String lastName, String address, String state, int zip, long phoneNumber, String eMail ){
	...
	class Addressbook {
		public static void main(String[] args) {
			...
			Collection<AddressBookSystemUC7> c = new ArrayList<AddressBookSystemUC7>();
			Collection<AddressBookSystemUC7> c1 = new ArrayList<AddressBookSystemUC7>();
			...
			do {
				...
				case 1:
					...
					Iterator<AddressBookSystemUC7> i = c.iterator();
					while(i.hasNext()) {
						AddressBookSystemUC7 e = i.next();
					...
					if(opt == 1) {
						c.add(new AddressBookSystemUC7(firstName, lastName, address, state, zip, phoneNumber, eMail));
					}
					if(opt == 2) {
						c1.add(new AddressBookSystemUC7(firstName, lastName, address, state, zip, phoneNumber, eMail));
					}
				break;
				case 2:
					System.out.print("1.Book_1 \n2.Book_2 \nChoose the Address Book : ");
				...
				case 3:
					  ...
					  if(opt == 1) {
						  ...
						  phoneNumber =  scan1.nextLong();
						  ListIterator<AddressBookSystemUC7> li =  ((ArrayList<AddressBookSystemUC7>) c).listIterator();
						  while(li.hasNext()) {
							  AddressBookSystemUC7 e = li.next();
							  	if(e.getPhoneNumber() == phoneNumber) {
							  		...
							  		eMail = scan.nextLine();
							  		System.out.print("1.Book_1 \n 2.Book_2 \n Choose the Address Book : ");
							  		li.set(new AddressBookSystemUC7(firstName, lastName , address, state, zip, phoneNumber, eMail));
							  		found = true;
							  	}
						  }
					  }
					  if(opt == 2) {
						  System.out.print("Enter the Phone Number to Edit the contact: ");
						  phoneNumber =  scan1.nextLong();
						  ListIterator<AddressBookSystemUC7> li =  ((ArrayList<AddressBookSystemUC7>) c1).listIterator();
						  while(li.hasNext()) {
							  AddressBookSystemUC7 e = li.next();
							  	if(e.getPhoneNumber() == phoneNumber) {
							  		System.out.print("Enter new First Name : ");
